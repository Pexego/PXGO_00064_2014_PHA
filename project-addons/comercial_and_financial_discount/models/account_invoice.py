...
class AccountInvoice(models.Model):
    ...
    @api.one
    def generate_comercial_discount(self, discount_percentage=None, many=False):
        line_obj = self.env['account.invoice.line']
        lines = line_obj.search([('invoice_id', '=', self.id), ('sale_line_ids', '!=', False)])
        line_by_taxes = self._get_lines_by_taxes(lines)
        self._create_comercial_lines_discount_by_taxes(line_by_taxes, discount_percentage)
...
class AccountInvoiceLine(models.Model):
    ...
    comercial_discount = fields.Boolean('Commercial discount', readonly=True)
