...
© 2017 Oscar Salvador (oscar.salvador@pharmadus.com)
*/
...
//            var $view = $('<iframe src="'+url+'#view=fitH" frameborder="1" width="100%" height="100%"></iframe>')
            var $view = $('<embed src="' + url + '#zoom=150" type="application/pdf" width="100%" height="100%"/>')
